...
import BookAppointmentFemale from './BookAppointmentFemale';
...
function Onpress(){
 return(
  setChecked({ checked: !checked }) && navigation.navigate(BookAppointmentFemale)
 )
}

 return (
  <ScrollView contentContainerStyle={{alignItems:'center', flex:1}}>
   <Image style={styles.image} source={require('../../assets/149.png')} />
   ...
   <View style={styles.view}>
    ...
    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: 24, alignItems: 'center' }}>
     <Text style={styles.text1}>Hairstyle</Text>
    ...
    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 11 }}>
     <Text style={styles.text2}>Saving</Text>
     <View style={styles.picker}>
      <Picker
    ...
    <View style={styles.pickerView}>
     <Text style={styles.text2}>Styling</Text>
     <View style={styles.picker}>
      <Picker
    ...
    <View style={styles.pickerView}>
     <Text style={styles.text2}>Trimming</Text>
     <View style={styles.picker}>
      <Picker
    ...
    <View style={styles.pickerView}>
     <Text style={styles.text2}>Haircut</Text>
     <View style={styles.picker}>
      <Picker
